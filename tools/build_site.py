...
<main class="wrap" id="top">
  ...
  <section id="next" class="final reveal">
    <div class="eyebrow" style="text-align:center">Next step</div>
    <h2>One call to start it.</h2>
    <p>Twenty minutes to walk the list, agree the first tier to work, and set who owns the
    partnership on each side. The list is built; the desk is here.</p>
    <div class="cta" style="justify-content:center">
      <a class="btn solid" href="mailto:nan@motdang.net?subject=RTP%20UK%20channel">Book the call</a>
    </div>
    <p class="note" style="text-align:center;margin-top:20px">Palida (Beer) · motdang.net /
    Hongdam, Chiang Rai · nan@motdang.net</p>
  </section>
